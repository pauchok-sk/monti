(() => {
    ...
    function showMore() {
        ...
        if (showBlocks.length) showBlocks.forEach((block => {
            ...
            inputShow.addEventListener("input", (e => {
                items.forEach((i => {
                    if (!i.classList.contains("hidden")) if (i.textContent.toLowerCase().includes(e.target.value.toLowerCase())) i.style.display = "block"; else i.style.display = "none";
                }));
            }));
        }));
    }
